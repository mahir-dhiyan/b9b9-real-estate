...
const About = () => {
    return (
        <div className="space-y-8 p-2 md:p-0">
            ...
            <h3 data-aos='zoom-in-down'  className="text-3xl text-[#5C2751] font-bold text-center mt-6">About Us</h3>
            <p data-aos='zoom-in-down' className="text-xl text-[#5C2751] font-bold">
            ...
            <h3 data-aos='zoom-in-down' className="text-3xl text-[#5C2751] font-bold text-center mt-6">Our Story</h3>
            <p data-aos='zoom-in-down' className="text-xl text-[#5C2751] font-bold">
            ...
            <h3 data-aos='zoom-in-down' className="text-3xl text-[#5C2751] font-bold text-center mt-6">Our Values</h3>
            <p data-aos='zoom-in-down' className="text-xl text-[#5C2751] font-bold">
